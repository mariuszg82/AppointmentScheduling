...
namespace AppointmentScheduling.Services
{
    public class AppointmentService : IAppointmentService
    {
        ...
        {
            //var startDate = DateTime.Parse(model.StartDate, CultureInfo.CreateSpecificCulture("en-EN"));
            //var endDate = DateTime.Parse(model.StartDate, CultureInfo.CreateSpecificCulture("en-EN")).AddMinutes(Convert.ToDouble(model.Duration));
